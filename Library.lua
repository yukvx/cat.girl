...
loadstring(game:HttpGet("https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/drawing.lua"))()
--
local libraryAssets = {
Gradient = {
...
--
Arrow = {
    arrowDown = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowdown.png";
    arrowUp = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowup.png";
};
--
Colorpicker = {
    colorpickerTransparencySlider = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/cptransparencybar.png";
    colorpickerTransparent = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/cptransparency.png";
    cursor = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/colorpickercursor.png";
    valsat = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/valsat.png";
    hue = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/hue.png";
};
}
--
do 
    LPH_NO_VIRTUALIZE(function()
        ...
        library = {
            ...
            folders = {
                main = "Clor.dev",
                assets = "Clor.dev/Images",
                configs = "Clor.dev/Configs"
            },
            shared = {
                initialized = false,
                fps = 0,
            ...
            function library:Loader(info)
                ...
                function window:CloseContent()
                    if window.currentContent.dropdown and window.currentContent.dropdown.open then
                        ...
                        utility:LoadImage(dropdown.dropdown_image, "arrow_down", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowdown.png")
                        --
                    ...
                    elseif window.currentContent.multibox and window.currentContent.multibox.open then
                        ...
                        utility:LoadImage(multibox.multibox_image, "arrow_down", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowdown.png")
                        --
        ...
        do
            ...
            function pages:PlayerList(info)
                ...
                for Index = 1, 1 do
                    ...
                    --
                    utility:LoadImage(button_image, "arrow_down", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowdown.png")
                    --
                    ...
                    function button:Open()
                        window:CloseContent()
                        button.open = not button.open
                        utility:LoadImage(button_image, "arrow_up", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowup.png")
                        --
                    ...
                    --
                    utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                    --
                    library.began[#library.began + 1] = function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 and (button_outline.Visible or button.open) and window.isVisible then
                            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and button_outline.Visible then
                                ...
                                elseif utility:MouseOverDrawing({button_outline.Position.X, button_outline.Position.Y, button_outline.Position.X + button_outline.Size.X, button_outline.Position.Y + button_outline.Size.Y}) and not window:IsOverContent() then
                                    task.spawn(function()
                                        utility:LoadImage(button_gradient, "gradientdown", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png") 
                                        --
                                        task.wait(0.15)
                                        --
                                        utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png") 
                ...
                --
                utility:LoadImage(list_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient(-130).png")
                --
            ...
            function sections:Toggle(info)
                ...
                --
                utility:LoadImage(toggle__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient(-130).png"
                    )
                --
                function toggle:Get()
                ...
                function toggle:Colorpicker(info)
                    ...
                    --
                    if transp then
                        utility:LoadImage(colorpicker__transparency, "cptransp", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/cptransparency.png")
                    end
                    utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient(-130).png")
                    --
                            ...
                            elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                                if not colorpicker.open then
                                    ...
                                    if transp then
                                        ...
                                        --
                                        utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/cptransparencybar.png")
                                    end
                                    --
                                    utility:LoadImage(colorpicker_open_picker_image, "valsat", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/colorpickercursor.png")
                                    utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/colorpickercursor.png")
                                    utility:LoadImage(colorpicker_open_huepicker_image, "hue", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/hue.png")
                                    --
                ...
                function toggle:Keybind(info)
                    ...
                    --
                    utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                    --
            ...
            function sections:Slider(info)
                ...
                --
                utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradientR2L.png")
                --
            ...
            function sections:TextBox(info)
                ...
                --
                utility:LoadImage(textbox_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                --
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and textbox_outline.Visible and window.isVisible then
                        if reactive and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + textbox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + textbox.axis + 20}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(textbox_gradient, "gradientdown", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(textbox_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png") 
            ...
            function sections:Dropdown(info)
                ...
                --
                utility:LoadImage(dropdown_image, "arrow_down", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowdown.png")
                utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                --
                if max then
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + (name and (15 + 20) or (20))}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(dropdown__gradient, "gradientdown", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png") 
                            ...
                            if not dropdown.open then
                                window:CloseContent()
                                dropdown.open = not dropdown.open
                                utility:LoadImage(dropdown_image, "arrow_up", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowup.png")
                                --
            ...
            function sections:Multibox(info)
                ...
                --
                utility:LoadImage(multibox_image, "arrow_down", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowdown.png")
                utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                --
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(multibox__gradient, "gradientdown", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png") 
                            ...
                            if not multibox.open then
                                window:CloseContent()
                                multibox.open = not multibox.open
                                utility:LoadImage(multibox_image, "arrow_up", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/arrowup.png")
                                --
                                ...
                                for i,v in pairs(multibox.options) do
                                    ...
                                    --
                                    utility:LoadImage(multibox_value_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")]]
                                    --
            ...
            function sections:Colorpicker(info)
                ...
                utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                --
                function colorpicker:Set(color, transp_val)
                    ...
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and colorpicker_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.secondColorpicker and (30+4) or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                            if not colorpicker.open then
                                ...
                                --
                                utility:LoadImage(colorpicker_open_picker_image, "valsat", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/valsat.png")
                                utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor","https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/colorpickercursor.png")
                                utility:LoadImage(colorpicker_open_huepicker_image, "hue", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/hue.png")
                                --
                                window.currentContent.frame = colorpicker_open_inline
            ...
            function sections:List(info)
                ...
                --
                utility:LoadImage(list_gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png")
                --
